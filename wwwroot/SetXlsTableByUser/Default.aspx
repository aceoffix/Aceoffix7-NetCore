<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.cs" Inherits="Aceoffix7_Net.SetXlsTableByUser.Default" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function OpenFile() {
            ...
            AceBrowser.openWindow('Excel?userName=' + userName, 'width=1200px;height=900px;');
        }
    </script>
</head>
<body>
