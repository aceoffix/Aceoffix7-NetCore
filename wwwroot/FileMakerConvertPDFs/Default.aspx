<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.cs" Inherits="Aceoffix7_Net.FileMakerConvertPDFs.Default" %>
 ...
 <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function ConvertFile(idArr, index) {
            ...
            var saveFileUrl = "/FileMakerConvertPDFs/SaveMaker";
            var openFileUrl = "/FileMakerConvertPDFs/Convert";
   ...
   <div style="margin:100px" align="center">
	...
	<table id="table1" >
		...
		<tr>
			...
			<td><a href="javascript:AceBrowser.openWindow('Edit?id=1','width=1150px;height=800px;');">Edit</a></td>
		</tr>
		<tr>
			<td><input name="check" type="checkbox" value="2"/></td>
			<td>02</td>
			<td>Aceoffix Trial Limits</td>
			<td><a href="javascript:AceBrowser.openWindow('Edit?id=2','width=1150px;height=800px;');">Edit</a></td>
		</tr>
		<tr>
			<td><input name="check" type="checkbox" value="3"/></td>
			<td>03</td>
			<td>Aceoffix License Policy</td>
			<td><a href="javascript:AceBrowser.openWindow('Edit?id=3','width=1150px;height=800px;');">Edit</a></td>
		</tr>
		<tr>
			<td><input name="check" type="checkbox" value="4"/></td>
			<td>04</td>
			<td>Introduction to Aceoffix</td>
			<td><a href="javascript:AceBrowser.openWindow('Edit?id=4','width=1150px;height=800px;');">Edit</a></td>
		</tr>
	</table>
